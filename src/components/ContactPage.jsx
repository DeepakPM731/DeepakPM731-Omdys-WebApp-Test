...
const ContactPage = () => {
  ...
  // const REACT_APP_PRIVATE_KEY = import.meta.env.VITE_REACT_APP_PRIVATE_KEY;
  ...
  // const appendSpreadsheet = async (row) => {
  //   try {
  //     // Create authentication object using Google service account credentials
  //     const serviceAccountAuth = new JWT({
  //       email: REACT_APP_CLIENT_EMAIL,
  ...
  //     const sheet = doc.sheetsById[REACT_APP_SHEET_ID];
  //     const result = await sheet.addRow(row);
  //     console.log('Data appended to spreadsheet:', result);
  //   } catch (error) {
  ...
  //   try {
  //     await axios.post(
  //       'https://script.google.com/macros/s/AKfycbxTQQdwuS0d3pbEnHtfsiI6ZudZ9dsWHFyq8KWKRBkwLGgcCqy2UDNAeL1AMauX87vj/exec',
  //       formData
  //     );
  //   } catch (error) {
  //     console.log(error);
