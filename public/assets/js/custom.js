...
*/
  ...
  if ($('.project-slider.owl-carousel')[0]) {
    const owl = $('.project-slider.owl-carousel');
    owl.owlCarousel({
      items: 2,
      margin: 12,
      dots: true,
    ...
    // --------------next
    $('#nextSlide').on('click touchstart', function (e) {
      e.preventDefault();
      owl.trigger('next.owl.carousel');
    });
    // --------------prev

    $('#prevSlide').on('click touchstart', function (e) {
      e.preventDefault();
  ...
  if ($('.team-slider')[0]) {
    ...
    // Go to the next item
    var x = $('.team-slider .owl-stage')
      .children('.team-slider .owl-item.active')
      .eq(0);
    x.addClass('open');
